...
class Encabezado extends Component {
    ...
    render(){
        const {terreno, totalAdmin, totalNorm, totalProy} = this.props
        return (
            <div>
                <div className='container-fluid'>
                    <div className='row'>
                        ...
                        <div className='col-sm-1 columna'><img id='MACO' src={macob} alt='macob' onClick={()=>{ this.onAbrirModal(terreno, 268, false)} } ></img></div>
