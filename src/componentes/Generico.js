...
class Generico extends Component {
    ...
    obtenerAsignados = campo => {
        varusuarios = campo.map((registro) => {
            vara = registro.Title;
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Encabezado rfs={this.props.rfs} idPITerr={!this.props.rfs ? this.props.idProyecto : this.props.idTerreno} terreno={this.props.terreno} maco={MACO} idVentana={this.state.idVentana} cambiarVentana={this.onCambiarVentana} 
                totalAdmin={totalAdmin} totalNorm={totalNorm} totalProy={totalProy} disabled={this.state.disabled} />
                {this.state.cargado ?
                    <div className='container-fluid'>
                        <Header datosVentana={idVentana === 4 ? this.state.datosVentanaEG.columnas : this.state.datosVentana.columnas} />
                        <Cluster idVentanaAnterior={this.state.idVentanaAnterior} titulos={this.state.clustersVentana} idVentana={idVentana} datos={idVentana === 4 ? this.state.datosVentanaEG.datos : this.state.datosVentana.datos} />
